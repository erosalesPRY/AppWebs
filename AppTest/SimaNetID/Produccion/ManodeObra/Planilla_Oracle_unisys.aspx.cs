...
namespace SIMANET_W22R.ManodeObra
{
    ...
    public partial class Planilla_Oracle_unisys : PaginaBase, IPaginaBase
    {
                    ...
                    switch (C_tipo_filtro)
                    {
                        ...
                        case "PROYECTO":
                            ...
                            if (N_PR > 0)
                            {
                                ...
                                ManodeObraSoapClient oMOB = new ManodeObraSoapClient();  // REFERENCIA AL SERVICIO
                                dt = oMOB.Conformidad(n_opcion, C_FECHA, sUser, sNivelC, N_PR, sTipoPL, sTaller, sLinea,
                                                                  null, null, null);
                                /*
                            ...
                            else
                            {
                                ...
                                ManodeObraSoapClient oMOB = new ManodeObraSoapClient();  // REFERENCIA AL SERVICIO
                                dt = oMOB.Conformidad(n_opcion, C_FECHA, sUser, sNivelC, N_PR, sTipoPL, sTaller, sLinea,
                                                                  C_filtro, C_tipo_filtro, C_data_filtro);
                                /*
                                    string C_FECHA        , string sUser             , string sNivelC = "L", 
                                    Int64 N_PR = 0       , string sTipoPL=null      , string sTaller="X32", string sLinea ="RN", 
                ...
                if (C_filtro == "SI")
                {
                    ...
                    switch (C_tipo_filtro)
                    {
                        ...
                        default:
                            ...
                            dt = oMOB1.Conformidad(n_opcion, C_FECHA, sUser, sNivelC, N_PR, sTipoPL, sTaller, sLinea,
                                                   null, null, null);
                            /*
                                string C_FECHA        , string sUser             , string sNivelC = "L", 
                                Int64 N_PR = 0       , string sTipoPL=null      , string sTaller="X32", string sLinea ="RN", 
        ...
        protected void prListar(Int64 n_opcion = 0) // OBTIENE UNA PLANILLA, Para filtrar solo las aprobadas pasar 1
        {
            ...
            try
            {
                ...
                ManodeObraSoapClient oMOB = new ManodeObraSoapClient();  // REFERENCIA AL SERVICIO
                DataTable dt = oMOB.BuscarPlanilla(sTipoPL, cTaller, C_FECHA, n_opcion);
                // quitamos los saltos
                c_pto = "3";
