<%@ Page Language="C#" AutoEventWireup="true" Async="true" 
    CodeBehind="Planilla_Oracle_unisys.aspx.cs"
   Inherits="SIMANET_W22R.Test.Planilla_Oracle_unisys"  %>
            ...
            <tr>
                <td> 
                      ...
                      <table class="w-100" >
                        <tr>
                            <td >
                                <asp:Label ID="Label1" runat="server" Text="Línea de Negocio:" CssClass="ItemGrilla"></asp:Label>
                            </td>
                        ...
                        <tr>
                            <td >
                                <asp:Label ID="Label2" runat="server" Text="Área Usuaria:" CssClass="ItemGrilla"></asp:Label>
                            </td>
                            <td>
                      ...
                      <!--   ********************************  -->       
                        <tr>
                            <td >
                                <asp:Label ID="Label3" runat="server" Text="Tipo de Planilla:" CssClass="ItemGrilla"></asp:Label>
                            </td>
                            <td>
                     ...
                     <!--   *******fila espacio*************************  -->    
                        ...
                        <tr>
                            <td >
                                <asp:Label ID="Label4" runat="server" Text="Fecha Planilla:" CssClass="ItemGrilla"></asp:Label>
                            </td>
                           <td>
                               <br/>
                       ...
                       <!--   *******fila espacio*************************  -->    
                        ...
                        <tr>
                           <td>
                               ...
                               <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Test/ReportePLL.aspx">Imprimir</asp:HyperLink>
